...
## Project Structure
    ...
    ├── testapiautoteammemb_90543  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_90543`
...
2. Clone this repo and `cd testapiautoteammemb_90543`
